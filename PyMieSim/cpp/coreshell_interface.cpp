...
PYBIND11_MODULE(CoreShellInterface, module) {
    ...
    py::class_<Scatterer>(module, "CORESHELL")
        ...
        .def("an", &CORESHELL::Scatterer::get_an_py, py::arg("max_order") = 0, "Returns the an coefficient.")
        .def("bn", &CORESHELL::Scatterer::get_bn_py, py::arg("max_order") = 0, "Returns the bn coefficient.")
