...
PYBIND11_MODULE(scatterer_set, module) {
    ...
    py::class_<SphereSet, ScattererSet, std::shared_ptr<SphereSet>>(module, "SphereSet")
        ...
        .def(
            ...
            [ureg](const SphereSet& self) {
                ...
                mapping["scatterer:material"] = self.property;
                mapping["scatterer:medium"] = self.medium_property;
                return mapping;
            },
            R"pdoc(
    ...
    //             mapping["scatterer:core_material"] = self.core_property;
    //             mapping["scatterer:shell_material"] = self.shell_property;
    //             mapping["scatterer:medium"] = self.medium_property;
    //             return mapping;
    //         },
    //         R"pdoc(
