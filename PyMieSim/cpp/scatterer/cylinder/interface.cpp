...
void register_cylinder(py::module_& module) {
    ...
    py::class_<Cylinder, BaseScatterer, std::shared_ptr<Cylinder>>(module, "CYLINDER")
        .def(
            "__init__",
            [](Cylinder &instance, py::object diameter, py::object refractive_index, py::object medium_refractive_index, const BaseSource &source) {
                ...
                new (&instance) Cylinder(diameter_meter, refractive_index_value, medium_refractive_index_value, source);
            },
            py::arg("diameter"),
