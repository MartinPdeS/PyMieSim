...
void Detector::initialize() {
    ...
    this->max_angle = this->numercical_aperture_to_angle(this->numerical_aperture / this->medium_refractive_index);
    this->min_angle = this->numercical_aperture_to_angle(this->cache_numerical_aperture / this->medium_refractive_index);

    std::cout<<"medium ri: "<<this->medium_refractive_index<<"   this->max_angle: "<<this->max_angle<<"  this->min_angle: "<<this->min_angle<<"\n";
...
double Detector::get_energy_flow(const BaseScatterer& scatterer) const {
