...
public:
     ...
     */
    virtual std::vector<double> get_poynting_field(const BaseScatterer& scatterer, double distance = 1) const = 0;
     ...
     */
    virtual double get_energy_flow(const BaseScatterer& scatterer) const = 0;
};
...
public:
    ...
    std::vector<double> get_poynting_field(const BaseScatterer& scatterer, double distance = 1) const override;

    double get_energy_flow(const BaseScatterer& scatterer) const override;
