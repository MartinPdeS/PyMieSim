...
void register_detector(py::module_& module) {
    ...
    py::class_<Detector, std::shared_ptr<Detector>>(module,
        "DETECTOR",
            R"pbdoc(
        ...
        .def(
            py::init(
                [](
                    ...
                    std::cout<<"medium_refractive_index_value: "<<medium_refractive_index_value<<"\n";
        ...
        .def("get_poynting_field",
            [](Detector& self, const BaseScatterer& scatterer, py::object distance) {
        ...
        .def(
            "get_energy_flow",
            [](Detector& self, const BaseScatterer& scatterer) {
