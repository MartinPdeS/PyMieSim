...
public:
    ...
    /**
     * @brief Computes the Stokes parameters over given phi and theta angles at a specified radius.
     *
     * @param phi Vector of azimuthal angles in radians.
     * @param theta Vector of polar angles in radians.
     * @param r The radius at which to compute the Stokes parameters.
     *
    ...
    {
        auto [E_phi, E_theta] = this->compute_structured_farfields(phi, theta, r);
