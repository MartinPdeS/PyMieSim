...
void register_base_scatterer(pybind11::module_& module) {
    ...
    pybind11::class_<BaseScatterer, std::shared_ptr<BaseScatterer>>(module, "BASESCATTERER")
        ...
        .def(
            "_cpp_get_s1s2",
            [ureg](BaseScatterer& self, const std::vector<double> &phi){
        ...
        .def(
            "_cpp_get_farfields",
            [ureg](BaseScatterer& self, const std::vector<double>& phi, const std::vector<double>& theta, const double& distance) {
