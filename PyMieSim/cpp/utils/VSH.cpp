...
std::vector<complex128> VSH::SPHERICAL::compute_dn(double nmx, complex128 z) //Page 127 of BH
{
...
std::tuple<std::vector<complex128>, std::vector<complex128>> VSH::SPHERICAL::MiePiTau(double mu, size_t max_order)
{
...
void VSH::SPHERICAL::MiePiTau(double mu, size_t max_order, complex128 *pin, complex128 *taun)
{
  pin[0] = 1.;
  pin[1] = 3. * mu;
...
std::vector<complex128> VSH::CYLINDRICAL::compute_dn(double nmx, complex128 z) //Page 205 of BH
{
std::vector<complex128> Dn(nmx, 0.0);
