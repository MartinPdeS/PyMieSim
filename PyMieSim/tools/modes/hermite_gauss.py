...
def get_hermite_gaussian_mode_field(
    ...
    n, m (int): Hermite-Gaussian mode indices (n for x, m for y).
...
def interpolate_from_fibonacci_mesh(fibonacci_mesh, **kwargs) -> numpy.ndarray:
    ...
    mode_field = get_hermite_gaussian_mode_field(coordinate[:2, :] / norm, **kwargs)
