...
PYBIND11_MODULE(scatterer_set, module) {
    ...
    auto format_scatterer_set_repr = [](const std::string& name, const ScattererSet& self) {
    ...
    py::class_<ScattererSet, std::shared_ptr<ScattererSet>>(
        module,
        "BaseScattererSet",
        R"pdoc(
            Abstract base class for scatterer set definitions.

            A scatterer set stores one or more scatterer parameter arrays used
            to generate the scatterer portion of an experiment grid.
        )pdoc"
    )
    ...
    .def_readonly(
        ...
        &ScattererSet::shape,
        R"pdoc(
            Length of each parameter axis contributing to the scatterer set.
        )pdoc"
    )
    .def_readonly(
        "total_combinations",
        &ScattererSet::total_combinations,
        R"pdoc(
            Total number of scatterer configurations generated by the set.
        )pdoc"
    )
    .def(
        "__repr__",
        [format_scatterer_set_repr](const ScattererSet& self) {
            return format_scatterer_set_repr("BaseScattererSet", self);
        }
    )
    ;
    ...
    py::class_<SphereSet, ScattererSet, std::shared_ptr<SphereSet>>(module, "SphereSet")
        ...
        .def(
            "__repr__",
            [format_scatterer_set_repr](const SphereSet& self) {
                return format_scatterer_set_repr("SphereSet", self);
            },
            R"pdoc(
                Return a concise representation showing the number of generated
                scatterer configurations and the set shape.
            )pdoc"
        )
        .def(
            "get_mapping",
    ...
    py::class_<InfiniteCylinderSet, ScattererSet, std::shared_ptr<InfiniteCylinderSet>>(module, "InfiniteCylinderSet")
        ...
        .def(
            "__repr__",
            [format_scatterer_set_repr](const InfiniteCylinderSet& self) {
                return format_scatterer_set_repr("InfiniteCylinderSet", self);
            },
            R"pdoc(
                Return a concise representation showing the number of generated
                scatterer configurations and the set shape.
    ...
    py::class_<CoreShellSet, ScattererSet, std::shared_ptr<CoreShellSet>>(module, "CoreShellSet")
        ...
        .def(
            "__repr__",
            [format_scatterer_set_repr](const CoreShellSet& self) {
                return format_scatterer_set_repr("CoreShellSet", self);
            },
            R"pdoc(
                Return a concise representation showing the number of generated
                scatterer configurations and the set shape.
