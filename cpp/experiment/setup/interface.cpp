...
#define DEFINE_GETTER_INTERFACE(property) \
    .def("get_"  #property, \
        [](Setup& self) { \
            ...
            return vector_to_numpy_copy(output, shape); \
        }, \
    ...
    .def("get_" #property "_sequential", \
        [](Setup& self) { \
            ...
            return vector_to_numpy_copy(output, {output.size()}); \
        }, \
        "Retrieves the scattering property for a scatterer" \
    )
    ...
    pybind11::class_<Setup>(module, "Setup")
        ...
        .def(
            ...
            [](Setup& self) {
                ...
                return vector_to_numpy_copy(coupling_array, {coupling_array.size()});
            },
            R"pbdoc(
        ...
        .def(
            ...
            [](Setup& self) {
                ...
                return vector_to_numpy_copy(coupling_array, coupling_shape);
            },
            R"pbdoc(
        ...
        .def(
            ...
            [](Setup& self, const FibonacciMesh& mesh, const double distance){
                ...
                return vector_to_numpy_copy(farfield_array, farfield_shape);
            },
            pybind11::arg("mesh"),
