    ...
    py::class_<Setup, std::shared_ptr<Setup>>(module,
        ...
        .def(
            ...
            [ureg](Setup& self, const py::object& angles)
            {
                ...
                py::array_t<complex128> s1_array = vector_to_numpy_copy(s1s2.first);
                py::array_t<complex128> s2_array = vector_to_numpy_copy(s1s2.second);
        ...
        .def(
            ...
            [ureg](
                ...
                py::array_t<double> i_array = vector_to_numpy_copy(std::get<0>(stokes_parameters), shape);
                py::array_t<double> Q_array = vector_to_numpy_copy(std::get<1>(stokes_parameters), shape);
                py::array_t<double> U_array = vector_to_numpy_copy(std::get<2>(stokes_parameters), shape);
                py::array_t<double> V_array = vector_to_numpy_copy(std::get<3>(stokes_parameters), shape);
        ...
        .def(
            ...
            [ureg](
                ...
                py::array_t<double> i_array = vector_to_numpy_copy(std::get<0>(stokes_parameters));
                py::array_t<double> Q_array = vector_to_numpy_copy(std::get<1>(stokes_parameters));
                py::array_t<double> U_array = vector_to_numpy_copy(std::get<2>(stokes_parameters));
                py::array_t<double> V_array = vector_to_numpy_copy(std::get<3>(stokes_parameters));
        ...
        .def(
            ...
            [ureg](
                ...
                py::array_t<complex128> phi_field_mesh = vector_to_numpy_copy(std::get<0>(farfield_meshes), shape);
                py::array_t<complex128> theta_field_mesh = vector_to_numpy_copy(std::get<1>(farfield_meshes), shape);
        ...
        .def(
            ...
            [ureg](
                ...
                py::array_t<complex128> e_phi_array = vector_to_numpy_copy(farfield_components.first);
                py::array_t<complex128> e_theta_array = vector_to_numpy_copy(farfield_components.second);
        ...
        .def(
            ...
            [ureg](
                ...
                py::array_t<double> spf_field_mesh = vector_to_numpy_copy(std::get<0>(spf_mesh), shape);
        ...
        .def(
            ...
            [ureg](
                ...
                py::array_t<double> spf_array = vector_to_numpy_copy(spf_values);
        ...
        .def(
            ...
            [ureg](
                ...
                py::array_t<complex128> nearfield_array = vector_to_numpy_copy(neafields);
        ...
        .def(
            ...
            [ureg](
                ...
                py::array_t<complex128> field_array = vector_to_numpy_copy(field);
        ...
        .def(
            ...
            [ureg](
                ...
                return vector_to_numpy_copy(field, {field.size()}) * ureg.attr("volt/meter");
            },
            pybind11::arg("x"),
            pybind11::arg("y"),
            pybind11::arg("z"),
