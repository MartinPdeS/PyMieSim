...
.. "auto_examples/Optimization:Opt-2-parameter.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_Optimization:Opt-2-parameter.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_Optimization:Opt-2-parameter.py:
...
.. _sphx_glr_download_auto_examples_Optimization:Opt-2-parameter.py:
