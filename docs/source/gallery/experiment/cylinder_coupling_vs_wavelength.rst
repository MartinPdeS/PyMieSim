...
.. "gallery/experiment/cylinder_coupling_vs_wavelength.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_experiment_cylinder_coupling_vs_wavelength.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_experiment_cylinder_coupling_vs_wavelength.py:
...
.. image-sg:: /gallery/experiment/images/sphx_glr_cylinder_coupling_vs_wavelength_001.png
   :alt: cylinder coupling vs wavelength
   :srcset: /gallery/experiment/images/sphx_glr_cylinder_coupling_vs_wavelength_001.png
...
.. _sphx_glr_download_gallery_experiment_cylinder_coupling_vs_wavelength.py:
